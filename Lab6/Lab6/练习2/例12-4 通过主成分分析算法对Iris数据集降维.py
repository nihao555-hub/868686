# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 23:42:57 2020
...
def main():
    ...
    for i in range(len(X_trans)):
        if y[i] == 0:
            red_x.append(X_trans[i][0])
            red_y.append(X_trans[i][1])
        elif y[i] == 1:
            blue_x.append(X_trans[i][0])
            blue_y.append(X_trans[i][1])
        else:
            green_x.append(X_trans[i][0])
            green_y.append(X_trans[i][1])
    plt.scatter(red_x, red_y, c='r', marker='x')
    plt.scatter(blue_x, blue_y, c='g', marker='^')
